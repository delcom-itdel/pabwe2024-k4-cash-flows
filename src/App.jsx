...
import CashFlowLabelsPage from "./pages/CashFlowLabelsPage";
import CashFlowStatsDailyPage from "./pages/CashFlowStatsDailyPage";
      ...
      <div>
        ...
        <main className="margin-main">
          <Routes>
            ...
            <Route path="/cash-flows/labels" element={<CashFlowLabelsPage />} />
            <Route
              path="/cash-flows/stats/daily"
              element={<CashFlowStatsDailyPage />}
            />
          </Routes>
        </main>
      </div>
